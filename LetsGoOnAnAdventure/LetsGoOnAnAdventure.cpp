...
// Function to get companions on final adventure
void oddsToGoFinals(bool companions[], int &count, string names[])
{
   int odds;
   int guess;
...
// Function for the first adventure
void night1(bool companions[], string name[])
{
   ...
   // While loop to check if the group has escaped
   while (escaped != true)
   {
...
// Function for the final adventure
